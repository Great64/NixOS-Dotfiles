...

{
  ...
  home.packages = with pkgs; [
    ...
    btop
    claude-code
    uv      # nixOS friendly python/pip
    python3 # system python for uv (UV_PYTHON_DOWNLOADS=never)
    rustup
  ...
  # or
  #
  #  /etc/profiles/per-user/great/etc/profile.d/hm-session-vars.sh
  #
